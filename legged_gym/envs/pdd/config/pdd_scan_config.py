...
class PddScanCfgPPO(PddBaseCfgPPO):
    seed = -1
    runner_name = 'rl_dream'  # rl, distil, mixed
    algorithm_name = 'ppo_scan'
...
class PddScanStairCfg(PddScanCfg):
    class terrain(PddScanCfg.terrain):
        curriculum = True
    ...
    class noise(PddScanCfg.noise):
        add_noise = False

    class domain_rand(PddScanCfg.domain_rand):
        switch = False
...
class PddScanStairCfgPPO(PddScanCfgPPO):
    class runner(PddScanCfgPPO.runner):
