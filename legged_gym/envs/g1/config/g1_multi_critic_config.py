...
class G1_Multi_Critic_Cfg(G1BaseCfg):
...
class T1_Multi_Critic_Stair_Cfg(G1_Multi_Critic_Cfg):
    class domain_rand(G1_Multi_Critic_Cfg.domain_rand):
        push_robots = True
        push_duration = [0.3]
    ...
    class terrain(G1_Multi_Critic_Cfg.terrain):
    ...
    class control(G1BaseCfg.control):
        # PD Drive parameters:
        stiffness = {
            'Head': 30,
    ...
    class algorithm(G1_Multi_Critic_Cfg.algorithm):
        entropy_coef = 0.01

        continue_from_last_std = False
        init_noise_std = 0.6

    class runner(G1_Multi_Critic_Cfg.runner):
...
class T1_Multi_Critic_Parkour_Cfg(G1_Multi_Critic_Cfg):
    class sensors(G1_Multi_Critic_Cfg.sensors):
        activated = True
    ...
    class rewards(G1_Multi_Critic_Cfg.rewards):
        class scales(G1_Multi_Critic_Cfg.rewards.scales):
            joint_pos = 5.
    ...
    class policy(G1_Multi_Critic_Cfg.policy):
        enable_reconstructor = True
