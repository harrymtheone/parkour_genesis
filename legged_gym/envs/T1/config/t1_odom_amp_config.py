...
class T1_Odom_AMP_Stair_Cfg(T1_Odom_AMP_Cfg):
    class domain_rand(T1_Odom_AMP_Cfg.domain_rand):
        push_robots = True
        push_duration = [0.3]
    ...
    class terrain(T1_Odom_AMP_Cfg.terrain):
    ...
    class rewards(T1_Odom_AMP_Cfg.rewards):
        class scales(T1_Odom_AMP_Cfg.rewards.scales):  # start, end, span, start_it
            joint_pos = 2.
            feet_contact_number = 1.2
            feet_clearance = 1.
            feet_distance = 0.2
    ...
    class algorithm(T1_Odom_AMP_Cfg.algorithm):
        continue_from_last_std = False
        init_noise_std = 0.6

    class runner(T1_Odom_AMP_Cfg.runner):
...
class T1_Odom_AMP_Finetune_Cfg(T1_Odom_AMP_Stair_Cfg):
    class sensors(T1_Odom_AMP_Stair_Cfg.sensors):
        activated = True

    class domain_rand(T1_Odom_AMP_Stair_Cfg.domain_rand):
        action_delay = True
        action_delay_range = [(2, 6)]

    class algorithm(T1_Odom_AMP_Stair_Cfg.algorithm):
        continue_from_last_std = False
        init_noise_std = 0.4

    class runner(T1_Odom_AMP_Stair_Cfg.runner):
