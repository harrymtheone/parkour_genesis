...
class PPO_PIE_AMP_Edge(BaseAlgorithm):
    ...
    def _build_amp_discriminator(self):
        ...
        params_dis = [
            {"params": self.amp_disc.trunk.parameters(), "weight_decay": amp_optim_cfg["amp_trunk_weight_decay"],
             "name": "amp_trunk",
             "lr": amp_optim_cfg["amp_disc_lr"]},
            {"params": self.amp_disc.amp_linear.parameters(), "weight_decay": amp_optim_cfg["amp_head_weight_decay"],
             "name": "amp_head",
             "lr": amp_optim_cfg["amp_disc_lr"]},
        ]
        ...
        self.amp_replay_buffer = AMPReplayBuffer(self.amp_disc.num_input, amp_optim_cfg["amp_replay_buffer_size"],
                                                 self.device)
