...
from rsl_rl.modules.utils import recurrent_wrapper, make_linear_layers
...
class Policy(nn.Module):
    ...
    def act(self, proprio, prop_his, depth, mixer_hidden_states, eval_=False, **kwargs):  # <-- my mood be like
        ...
        return self.distribution.sample(), vel, z, mixer_hidden_states

    def actor_forward(self, proprio, vel, z):
        mean = self.actor(proprio, vel, z)
